...
class ScanThread(QThread):
    ...
    def run(self):
        try:
            ...
            self.status.emit(
                f"{ANALYZING_PATHS_MSG} [Source: {source_path_display}] [Destination: {dest_path_display}]")
